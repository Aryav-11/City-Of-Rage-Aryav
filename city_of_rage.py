...
class Player():
    ...
    def make_health_bar(self):
        ...
        name = font.render("Aryav", True, WHITE)
        surface1.blit(name, (22, -2))
        return surface1
                     
    def scroll_background(self):
        if scroll_ok:
           if self.axis_pos[0] > CENTER_X:
    ...
    def grab(self):
        ...
        if jump:
           ...
           if self. health > 10:
              ...
              self.change_animation('special_move1')
              sounds['special_move2'].play()
        elif attack and not (self.hit_connect or self.attack_type):
           if self.grab_attack_couunt >= 3 and self.grab_type == "front":
              self.grab_attack_couunt = 0
              self.attack_type = "strong"
              self.current_state = 'attack'
              ...
              and ((left and self.direction == 1) or (right and self.direction == -1)):
                 ...
                 self.throw_sequence = [(-20, 0), (-20, 0), (-20, 0), (-2, -9), (-2, -9)]
                 sounds['special_move1'].play()
...
def main():
    ...
    level_data = [{'x_pos': 0, 'enemies':((galsia, -150, 180), (galsia, 450, 180), (galsia, 470, 200))},
                  {'x_pos': 400, 'enemies':((galsia, -50, 180), (galsia, 380, 180), (galsia, 380, 200))},
                  {'x_pos': 1216, 'enemies':((Big_Ben, 350, 180), (galsia, 380, 180), (galsia, -50, 200))}]
